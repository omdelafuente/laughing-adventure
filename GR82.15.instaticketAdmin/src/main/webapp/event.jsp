...
<body class="w3-content" style="max-width: 1200px">
	...
	<div class="w3-main" style="margin-left: 250px">
		...
		<!-- Se muestra la información del evento -->
		<%
		...
		<div class="w3-main">
			<div class="w3-row">
				...
				<div class="w3-col s3 w3-center">
					...
					%>
					<a href="chat?userEmail=<%=event.getCreator().getEmail()%>">
					<span class="w3-tag w3-large w3-padding-large w3-light-grey w3-center w3-hover-grey" style="cursor: pointer"> 
