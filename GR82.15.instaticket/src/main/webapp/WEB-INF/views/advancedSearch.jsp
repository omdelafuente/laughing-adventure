			...
			<div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width: 650px">
				...
				<form id="searchForm" class="w3-container" method="post" action="search">
					<div class="w3-section">
						...
						<input name="title" class="w3-input w3-border w3-light-grey w3-margin-bottom " type="text" maxlength="30">
						<label><b>Categoría</b></label>
						<select name="category" class="w3-select w3-border w3-light-grey w3-margin-bottom ">
						...
						<input class="w3-input w3-border w3-light-grey w3-margin-bottom " type="text" name="place" maxlength="25">
						<div class="w3-row">
							<div class="w3-center">Intervalo de fechas</div>
							<div class="w3-container w3-half">
								<label><b>Desde</b></label>
								<input class="w3-input w3-border w3-light-grey w3-margin-bottom " type="date" name="dateMin">
							</div>
							<div class="w3-container w3-half">
								<label><b>Hasta</b></label>
								<input class="w3-input w3-border w3-light-grey w3-margin-bottom " type="date" name="dateMax">
							</div>
						</div>
						...
						<div class="w3-row">
							...
							<div class="w3-container w3-half">
								...
								<input class="w3-input w3-border w3-light-grey w3-margin-bottom " type="number" name="priceMin" min="0.0"
									max="9999.99" step=".01">
							</div>
							<div class="w3-container w3-half">
								<label><b>Precio máximo</b></label>
								<input class="w3-input w3-border w3-light-grey w3-margin-bottom " type="number" name="priceMax" min="0.0"
									max="9999.99" step=".01">
							</div>
						</div>
						<label><b>Texto en descripción</b></label>
						<input name="description" class="w3-input w3-border w3-light-grey w3-margin-bottom " type="text"
							maxlength="50">
						<label><b>Estado</b></label>
						<select name="state" class="w3-select w3-border w3-light-grey w3-margin-bottom ">
